...
const MODIFIER_META: Record<keyof GameModifiers, ModifierMeta> = {
  ...
  disablePushYourLuck:              { label: 'Disable Push Luck',      kind: 'additive',       step: 1,    min: 0,    defaultValue: 0,    description: 'Assignment constraint: > 0 banks straight through, no push prompt' },
