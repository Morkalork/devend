...
const MODIFIER_META: Record<keyof GameModifiers, ModifierMeta> = {
  ...
  spendCapturePerChunk:             { label: 'Spend Capture/Chunk',    kind: 'additive',       step: 0.05, min: 0,    defaultValue: 0,    description: 'Budget Cycle (Retained Earnings): next-map board pre-capture per 60h spent (0.05 = +5%)' },
