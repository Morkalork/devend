...
const MODIFIER_META: Record<keyof GameModifiers, ModifierMeta> = {
  ...
  ballDensityBonus:                 { label: 'Ball Density Bonus',     kind: 'additive',       step: 0.1,  min: 0,    defaultValue: 0,    description: 'Treasure chest (heavier balls): run-wide +mass so balls smash breakables harder' },
