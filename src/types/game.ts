...
export type GameScreen = 'welcome' | 'tutorial' | 'game' | 'upgradeShop' | 'doorDraft' | 'capstoneDraft' | 'tierDraft' | 'assignmentSummary' | 'runDraft' | 'ascensionDraft' | 'result' | 'certificateStore' | 'loadouts' | 'options' | 'achievements' | 'hallOfFame' | 'admin' | 'mapBuilder' | 'animationTest';
