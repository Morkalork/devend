...
export type GameScreen = 'welcome' | 'tutorial' | 'game' | 'upgradeShop' | 'runDraft' | 'ascensionDraft' | 'result' | 'certificateStore' | 'options' | 'achievements' | 'admin' | 'mapBuilder' | 'animationTest';
