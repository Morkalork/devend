...
export type GameScreen = 'welcome' | 'tutorial' | 'game' | 'upgradeShop' | 'doorDraft' | 'capstoneDraft' | 'tierDraft' | 'runDraft' | 'ascensionDraft' | 'result' | 'certificateStore' | 'loadouts' | 'options' | 'achievements' | 'hallOfFame' | 'admin' | 'mapBuilder' | 'animationTest';
